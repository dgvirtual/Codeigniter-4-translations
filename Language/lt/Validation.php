...
return [
   ...
   'alpha_numeric_punct'   => 'Lauke {field} gali būti tik raidės, skaičiai, tarpai bei  ~ ! # $ % & * - _ + = | : . simboliai.',
   ...
   'hex'                   => 'Lauje {field} gali būti tik šešioliktainiai skaičiai.',
   ...
   'is_not_unique'         => 'Lauke {field} turi būti duomenų bazėje jau esanti vertė.',
   ...
   'valid_email'           => 'Lauke {field} turi būti taisyklingas el. pašto adresas.',
